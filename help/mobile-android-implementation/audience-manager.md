...
description: Learn how to implement Adobe Audience Manager on your website using Server-Side Forwarding and Experience Platform Launch. This lesson is part of the Implementing the Experience Cloud in Mobile Android Applications tutorial.
seo-description:
...
1. Adding the Experience Cloud Mobile SDK and Analytics extension to the app, ***which you have already done** in the Configuring Experience Platform Launch lessons
