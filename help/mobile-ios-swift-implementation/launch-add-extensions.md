...
description: Learn how to add extensions to a mobile Experience Platform Launch property. This lesson is part of the Implementing the Experience Cloud in Mobile iOS Swift Applications tutorial.
seo-description:
...
>[!NOTE]
>
>If you do not have a license for Adobe Target, you can skip this section. At this time, the [!DNL Target] extension for mobile properties is used solely to manage SDK settings and does not add interface options to Experience Platform Launch, such as Rule actions.
